...
const ActivateAccount: React.FC = () => {
    ...
    useEffect(() => {
        const activateAccount = async () => {
            ...
            try {
                const response = await axios.get(`${URL_AUTH}/users/activate?token=${token}`);
                ...
                {status === 'success' && (
                    <div style={styles.message}>
                        ...
                        <p style={styles.successText}>
                            Congratulations! Your CareerLaunch account has been successfully activated.
                        </p>
                ...
                {status === 'error' && (
                    <div style={styles.message}>
                        ...
                        <p style={styles.errorText}>
                            There was an issue activating your account. The token may be invalid or expired.
